...
do_defconfig()
{
	...
	cat <<-EOF | tee "${SCRIPT_DIR}/coreboot/configs/config.$_board"
		...
		CONFIG_PAYLOAD_BUILD_GRUB2=y
		CONFIG_PAYLOAD_OPTIONS=""
		CONFIG_TIANOCORE_UEFIPAYLOAD=y
		# CONFIG_TIANOCORE_COREBOOTPAYLOAD is not set
		CONFIG_TIANOCORE_TAG_OR_REV="origin/uefipayload_202107"
		...
		# CONFIG_GRUB2_INCLUDE_RUNTIME_CONFIG_FILE is not set
		CONFIG_GRUB2_SECONDARY_PAYLOAD=y
		CONFIG_TIANOCORE_BOOT_TIMEOUT=3
		CONFIG_TIANOCORE_BOOTSPLASH_FILE="bootsplash.bmp"
		CONFIG_PAYLOAD_TIANOCORE=y
		CONFIG_PAYLOAD_FILE="payloads/external/tianocore/tianocore/Build/UEFIPAYLOAD.fd"
		CONFIG_TIANOCORE_UEFIPAYLOAD=y
		# CONFIG_TIANOCORE_UPSTREAM is not set
		# CONFIG_TIANOCORE_COREBOOTPAYLOAD is not set
		# CONFIG_TIANOCORE_CUSTOM is not set
		CONFIG_TIANOCORE_REPOSITORY="https://github.com/mrchromebox/edk2"
		CONFIG_TIANOCORE_TAG_OR_REV="origin/uefipayload_202107"
		# CONFIG_TIANOCORE_DEBUG is not set
		CONFIG_TIANOCORE_RELEASE=y
		# CONFIG_TIANOCORE_ABOVE_4G_MEMORY is not set
		CONFIG_TIANOCORE_BOOT_MANAGER_ESCAPE=y
		# CONFIG_TIANOCORE_CBMEM_LOGGING is not set
		# CONFIG_TIANOCORE_FOLLOW_BGRT_SPEC is not set
		CONFIG_TIANOCORE_HAVE_EFI_SHELL=y
		CONFIG_TIANOCORE_PRIORITIZE_INTERNAL=y
		CONFIG_TIANOCORE_PS2_SUPPORT=y
